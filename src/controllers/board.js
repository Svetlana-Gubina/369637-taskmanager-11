...
const renderTasks = (taskListElement, tasks, onDataChange) => {
  return tasks.map((task) => {
    const taskController = new TaskController(taskListElement, onDataChange);    taskController.render(task);
...
export default class BoardController {
  ...
  _renderLoadMoreButton() {
    ...
    const container = this._container.getElement();
    render(container, this._loadMoreButtonComponent, Position.BEFOREEND);
